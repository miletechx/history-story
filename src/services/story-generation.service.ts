...
4. 叙述节奏要自然变化：紧张处多用短句，关键转折前后自然留出停顿感，平缓处可以用更舒展的句子。
5. 在不违背关键史实的前提下，可以补充合理的场景细节和心理描写，但不能编造关键历史结论。
6. 不要输出标题、列表、编号、Markdown、括号说明、舞台指令、语速标记或情绪标记。
7. 不要像流水账，不要像课堂总结，不要使用“首先、其次、最后”“这个故事告诉我们”等生硬表达。
8. 故事长度约1000-1500字，结尾要自然收束，留下回味。
